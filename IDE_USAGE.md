...
*Open the project:*<br>
Run Code::Blocks, and open the project in `ElsMagmaBooster/build/codeblocks`.<br>
Finally, build and run the project.
...
cd ElsMagmaBooster
mkdir ../eclipse-ElsMagmaBooster
cd ../eclipse-ElsMagmaBooster

# Generate an Eclipse project
cmake ../ElsMagmaBooster -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-ElsMagmaBooster`.<br>
